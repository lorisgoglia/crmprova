...
const collaboratorValidator = Yup.object().shape({
    ...personalInfoValidator.fields,
    ...addressInfoValidator.fields,
})

export { personalInfoValidator, addressInfoValidator, collaboratorValidator }
